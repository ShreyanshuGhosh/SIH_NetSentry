...
export const COMPLIANCE_RULES: ComplianceRule[] = [
  // ─── CIS Controls v8 ───
  {
    ...
    description: "SSH protocol version 2 is strictly enforced. Insecure SSHv1 is disabled. SSH protocol version is not locked to version 2. Legacy SSHv1 exposes session to MITM attacks.",
  ...
  },
  {
    ...
    description: "Clear-text Telnet daemon is completely disabled. Telnet service is actively permitted. Passwords and CLI commands transmit in plaintext over network.",
  ...
  },
  {
    ...
    description: "Unencrypted HTTP web server daemon is disabled. Management web sessions enforce TLS. Plaintext HTTP server is enabled. Administrative sessions subject to cleartext credential sniffing.",
    frameworkRef: "CIS Controls v8 Safeguard 4.8 / 12.6",
  ...
  },
  {
    ...
    description: "Local administrative password hashes are cryptographically obfuscated with modern one-way ciphers. Local passwords stored in plaintext or reversible ciphers (e.g. Cisco Type 7).",
  ...
  },
  {
    ...
    description: "Centralized AAA authentication service (TACACS+/RADIUS) is actively enforced for CLI logins. AAA authentication model disabled. Device relies exclusively on standalone local accounts.",
  ...
  },
  {
    ...
    description: "SNMP is restricted to version 3 with cryptographic authPriv security. SNMPv1 or SNMPv2c legacy protocol detected with plaintext community strings.",
  ...
  },
  {
    ...
    description: "Centralized remote syslog forwarding is actively directed to external SIEM. No external syslog logging host defined. Audit records exist solely in volatile local memory.",
  ...
  },
  {
    ...
    description: "Administrative session inactivity timeout is configured for 15 minutes or less. Inactivity timeout is missing or set above 15 minutes, leaving unattended sessions vulnerable.",
  ...
  },
  {
    ...
    description: "Device internal clock is synchronized to authoritative NTP time reference servers. No synchronized NTP time server defined. System clock will drift, invalidating forensic timestamps.",
  ...
  },
  {
    ...
    description: "Mandatory statutory warning and consent notice banner is displayed upon connection. Legal advisory notice banner missing prior to authentication prompt.",
  ...
  },
  {
    ...
    description: "Insecure ICMP Redirects are disabled on all network interfaces. ICMP Redirects are enabled. Rogue systems can poison device routing cache to conduct MITM traffic interception.",
    ...
    evaluate: (p) => (p.icmpRedirectsDisabled === true || p.icmp_redirects_disabled === true ? "pass" : "fail"),
    remediation: {
  ...
  },
  {
    ...
    description: "Proxy ARP is disabled on all interfaces, preventing ARP table spoofing. Proxy ARP is active. Network is vulnerable to ARP spoofing, DoS exhaustion, and topology reconnaissance.",
    frameworkRef: "CIS Controls v8 Safeguard 12.1",
    sourceNote: "CIS Controls v8, Safeguard 12.1 (Ensure Network Infrastructure is Kept Up to Date - Disable Proxy ARP)",
    evaluate: (p) => (p.proxyArpDisabled === true || p.proxy_arp_disabled === true ? "pass" : "fail"),
    remediation: {
      cisco_ios: "configure terminal\ninterface range Gi0/0 - 3\nno ip proxy-arp\nend\nwrite memory",
  ...
  },
  {
    ...
    description: "IP Source Routing is disabled. Packets with sender-dictated path headers are dropped. IP Source Routing is enabled. Attackers can bypass perimeter firewall filtering by prescribing exact transit hops.",
    frameworkRef: "CIS Controls v8 Safeguard 12.1",
    sourceNote: "CIS Controls v8, Safeguard 12.1 (Disable IP Source Routing)",
    evaluate: (p) => (p.ipSourceRoutingDisabled === true || p.ip_source_routing_disabled === true ? "pass" : "fail"),
    remediation: {
      cisco_ios: "configure terminal\nno ip source-route\nend\nwrite memory",
  ...
  },
  {
    ...
    description: "IP Directed Broadcast is disabled, preventing network participation in Smurf DoS attacks. IP Directed Broadcast is active. Subnets can be weaponized as broadcast reflection amplifiers in DDoS attacks.",
    frameworkRef: "CIS Controls v8 Safeguard 12.1",
    sourceNote: "CIS Controls v8, Safeguard 12.1 (Disable IP Directed Broadcasts)",
    evaluate: (p) => (p.directedBroadcastDisabled === true || p.directed_broadcast_disabled === true ? "pass" : "fail"),
    remediation: {
  ...
  },
  {
    ...
    description: "Unencrypted link discovery protocols (CDP/LLDP) are disabled globally. Discovery protocols (CDP/LLDP) transmit unauthenticated chassis models, OS revisions, and IP addresses.",
    ...
    evaluate: (p) => (p.discoveryProtocolsDisabled === true || p.discovery_protocols_disabled === true ? "pass" : "fail"),
    remediation: {
      cisco_ios: "configure terminal\nno cdp run\nno lldp run\nend\nwrite memory",
  ...
  },
  {
    ...
    description: "Administrative management lines (VTY) are restricted by an explicit ingress security access-list. VTY terminal lines permit management connections from any source IP without access-class filtering.",
    ...
    evaluate: (p) => (p.vtyAccessClassConfigured === true || p.vty_access_class_configured === true ? "pass" : "fail"),
    remediation: {
  ...
  },
  {
    ...
    description: "NTP packets are authenticated using SHA/MD5 cryptographic pre-shared keys. NTP authentication is not enabled. Time source packets can be forged or altered in transit.",
    frameworkRef: "CIS Controls v8 Safeguard 8.4",
    sourceNote: "CIS Controls v8, Safeguard 8.4 (Standardize Time Synchronization - NTP Cryptographic Authentication)",
    evaluate: (p) => (p.ntpAuthenticated === true || p.ntp_authenticated === true ? "pass" : "fail"),
    remediation: {
  ...
  },
  {
    ...
    description: "Default SNMP community strings 'public' and 'private' are removed. Default SNMP community string ('public' or 'private') detected. Allows unauthorized MIB tree enumeration.",
    frameworkRef: "CIS Controls v8 Safeguard 4.8",
    sourceNote: "CIS Controls v8, Safeguard 4.8 (Prohibit Default Community Strings)",
    evaluate: (p) => (p.snmpDefaultCommunityDisabled === true || p.snmp_default_community_disabled === true ? "pass" : "fail"),
    remediation: {
  ...
  },
  {
    ...
    description: "Dynamic AAA authentication server reachability and latency SLA verified via active probe. AAA servers unverified or failing active reachability and response latency requirements.",
    frameworkRef: "CIS Controls v8 Safeguard 12.5",
    ...
    evaluate: () => "checking_infra_missing",
    remediation: {
  ...
  },
  {
    ...
    description: "Active ingestion and structured schema parsing of syslog events verified in SIEM pipeline. SIEM ingestion pipeline unverified or security events dropping before indexing.",
    frameworkRef: "CIS Controls v8 Safeguard 8.2",
  ...
  },
  {
    ...
    description: "Out-of-band management network air-gap and VRF isolation verified against packet leakage. OOB isolation unverified or cross-VRF route leaking detected between management and data planes.",
    frameworkRef: "CIS Controls v8 Safeguard 12.2",
  ...
  },
  {
    ...
    description: "Active live reachability of CA CRL distribution points and OCSP responders validated. PKI certificate revocation checks failing or OCSP responders unreachable from device.",
  ...
  },
  {
    ...
    description: "CoPP hardware rate-limiters active in TCAM and control plane CPU utilization within safe thresholds. CoPP hardware counters unmonitored or rate-limiting thresholds dropping legitimate control traffic.",
    frameworkRef: "CIS Controls v8 Safeguard 12.1",
  ...
  },
  {
    ...
    description: "Physical enclosure tamper microswitches, cabinet locks, and SFP port security sensors verified active. Physical security sensors unmonitored or cabinet locks in open/alarm state.",
